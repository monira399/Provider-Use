      ...
      appBar: AppBar(
        ...
        title: Row(
          children: [
            ...
            Text('EasyShop', style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white,fontSize: 22
            ),),
          ],
        ),
        actions: [
              ...
              children: [
                ...
                Consumer<ProductListProvider>(
                  builder: (context, productListProvider, _) {
                    return Badge(
                      label: Text(productListProvider.cartItemCount.toString(),style: const TextStyle(
                        color: Colors.white,
                        fontSize: 10,
                            ...
                            child: Stack(
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      Center(
                                        child: Image.network(product.thumbnail, height: 100,width: 90,
                                            fit: BoxFit.contain),
                                      ),
                                      ...
                                      Row(
                                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                        children: [
                                          Text('\$${product.price}', style: TextStyle(color: Colors.green, fontWeight: FontWeight.w600),),
                                          Text('⭐   ${product.rating}'),
                                        ],
                                      ),
